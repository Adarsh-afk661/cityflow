...
export const INITIAL_BASE_ROUTES: CandidateRoute[] = [
  {
    ...
    corridorName: 'Expressway A-10 Direct Tunnel Route',
    distanceKm: 34.2,
    baseDurationMin: 82,
    currentEtaMin: 82,
    predictedTimeRange: { min: 78, max: 88 },
    reliabilityScore: 72,
    delayRiskPercent: 24,
    safetyScore: 78,
    safetyBreakdown: {
    ...
    estimatedCo2Kg: 18.4,
    co2SavingsKg: 0,
    fuelImpactLiters: 6.9,
    trafficLevel: 'heavy',
    clearanceStatus: 'failed',
    clearanceChecks: [],
    overallScore: 68,
    pathWaypoints: [
      { x: 220, y: 480, name: 'Central Warehouse' },
      { x: 290, y: 410 },
      { x: 370, y: 350, name: 'Metro Rail Underpass (3.8m)' },
      { x: 450, y: 270 },
      { x: 540, y: 180 },
      { x: 620, y: 120, name: 'North Distribution Hub' }
    ],
  ...
  },
  {
    ...
    corridorName: 'Outer Ring Beltway & Grand River Flyover',
    distanceKm: 41.5,
    baseDurationMin: 96,
    currentEtaMin: 96,
    predictedTimeRange: { min: 92, max: 100 },
    reliabilityScore: 94,
    delayRiskPercent: 8,
    safetyScore: 91,
    safetyBreakdown: {
  ...
  },
  {
    ...
    corridorName: 'Eco-Flow Parkway & Green Viaduct',
    distanceKm: 38.8,
    baseDurationMin: 95,
    currentEtaMin: 95,
    predictedTimeRange: { min: 92, max: 98 },
    reliabilityScore: 92,
    delayRiskPercent: 9,
    safetyScore: 88,
    safetyBreakdown: {
