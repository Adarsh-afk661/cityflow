...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0 h-screen sticky top-0 select-none z-30 shadow-[1px_0_4px_rgba(0,0,0,0.02)]">
      {/* Brand Header */}
      <div>
        <div className="p-5 pb-4 border-b border-slate-100">
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActivePage('landing')}>
          ...
          <button
            ...
            className="mt-4 w-full py-2 px-3 rounded-lg bg-[#ecfdf5] hover:bg-emerald-100/80 border border-emerald-200 text-[#166534] text-xs font-bold flex items-center justify-center space-x-2 transition shadow-sm"
          >
          ...
          {navItems.map(item => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs md:text-sm font-semibold transition-all ${
                  isActive
